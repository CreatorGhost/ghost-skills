...
<p align="center">
  ...
  <img alt="gate" src="https://img.shields.io/badge/verification-7%20gates-d97757">
  <img alt="smells" src="https://img.shields.io/badge/false--green%20smells-11-3fb950">
</p>
...
2. Red test   — reproduce the risk; watch it FAIL on the broken code
3. Real       — drive the actual exported fn / endpoint / binary
4. Assert     — the content contract, not liveness
5. Edges      — empty, over-the-limit, wrong-encoding, malformed, the unhappy path
6. Boundary   — ≥1 real-I/O / contract test where reality diverges from your model
7. Verify     — fix is in the SHIPPED build + production logs show zero new errors
```
